...
VideoCaptured::VideoCaptured(QObject *parent, QString classesPath, QString configPath, QString weightsPath, QString mediaPath):
    QThread {parent},
                        ...
                        if(classes[((*it).classID)] == classes[i]){
                            ...
                            if (countObj[i] == 5){
                                ...
                                if (dir.exists()){
                                    ...
                                    sendTelegramPhoto(telegramUser, basePath+"result/"+classes[i]+".png", "We found your " + classes[i] +"!");
                                } else{
