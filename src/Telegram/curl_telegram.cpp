...
void sendTelegram(string message, string bot_token, string chatId){
    string url = "https://api.telegram.org/bot" + bot_token + "/sendMessage?chat_id=" + chatId + "&parse_mode=Markdown&text=" + message;
...
void sendTelegramPhoto(string chat_id, string bot_token, string path_to_photo, string caption = NULL){
    CURL *curl;
    CURLcode response;
